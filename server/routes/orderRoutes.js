...
router.post("/", authMiddleware, requireCsrf, orderController.createOrder); // Require auth to create order
...
router.put("/:id", authMiddleware, requireCsrf, orderController.updateOrderStatus);
